        ...
        <table>
          <thead>
            <tr>
                <th><h1>Títulos</h1></th>
                <th class="crear-tit">
                  <button type="submit" class="BOTON-CREAR"><a href="crear_titulo.blade.php">CREAR TÍTULO</a></button>
                </th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td>Ejemplo: Grado Medio Cocina y gastronomía</td>
              <td>
                <button class="btn-modificar"><a href="modificar_titulo.blade.php">MODIFICAR</a></button>
                <button class="btn-elim">ELIMINAR</button>
              </td>
            </tr>
            <tr>
              <td>Nombre del Título</td>
                <td>
