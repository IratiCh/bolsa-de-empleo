...
import PerfilEmpresa from "./components/empresa/perfil_empresa.jsx";
...
import ModificarOferta from "./components/empresa/modificar_oferta.jsx";
    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route
                    path="/registro_demandante"
                    element={<RegistroDemandante />}
                />
                <Route path="/registro_empresa" element={<RegistroEmpresa />} />

                <Route
                    path="/centro/dashboard_centro"
                    element={
                ...
                <Route
                    path="/centro/modificar_titulo/:id"
                    element={
                        <ProtectedRoute requiredRole="centro">
                            <ModificarTitulo />
                        </ProtectedRoute>
                ...
                <Route
                    path="/empresa/dashboard_empresa"
                    element={
                ...
                <Route
                    path="/empresa/asignar_oferta/:id"
                    element={
                        <ProtectedRoute requiredRole="empresa">
                            <AsignarOferta />
                        </ProtectedRoute>
                ...
                <Route
                    path="/empresa/modificar_oferta/:id"
                    element={
                        <ProtectedRoute requiredRole="empresa">
                            <ModificarOferta />
                        </ProtectedRoute>
                ...
                <Route
                    path="/demandante/dashboard_demandante"
                    element={
                ...
                <Route
                    path="/demandante/perfil_demandante"
                    element={
                        <ProtectedRoute requiredRole="demandante">
                            <PerfilDemandante />
                        </ProtectedRoute>
                ...
                <Route
                    path="/demandante/ofertas_inscritas"
                    element={
                        <ProtectedRoute requiredRole="demandante">
                            <OfertasInscritas />
                        </ProtectedRoute>
