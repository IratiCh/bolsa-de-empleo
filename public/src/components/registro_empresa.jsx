...
const RegistroEmpresa = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                setSuccessMessage(
                    "Usuario registrado. Espere a que se valide la cuenta antes de iniciar sesión.",
                );
                setErrorMessage("");
        ...
        <div className="registro-body">
            <div className="container registro-container">
                <div className="left-section">
                    ...
                    <h2>Ofrece trabajo según las necesidades de la empresa</h2>
                    <img
