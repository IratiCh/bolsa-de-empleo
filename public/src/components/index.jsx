        ...
        <div className="index-body">
            <div className="different-bg">
                ...
                <div className="container index-container">
                    <h1>Inicia Sesión</h1>
                    <p className="intro">
                        Bienvenido al punto de encuentro donde el talento y las
                        oportunidades se conectan. Ya seas una persona en busca
                        de tu próximo desafío profesional o una empresa en busca
                        de los mejores perfiles, aquí encontrarás las
                        herramientas y el apoyo necesario para lograrlo. Únete a
                        nuestra comunidad y empieza a construir el futuro que
                        deseas.
                    </p>
                    ...
                    <p className="register">
                        ...
                        <Link to="/registro_demandante">
                            Regístrate para trabajar
                        </Link>
                        |
                        <Link to="/registro_empresa">
                            Regístrate para ofrecer trabajo
                        </Link>
                    </p>
                </div>
            </div>
