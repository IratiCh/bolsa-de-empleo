    ...
    useEffect(() => {
        const fetchOferta = async () => {
            try {
                ...
                if (!inscResponse.ok) {
                    setError(
                        inscData.error || "Error al verificar inscripción",
                    );
                    return;
                }
    ...
    const handleInscripcion = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `/api/demandante/ofertas/${id}/inscribirse`,
                {
                    method: "POST",
                    headers: {
            ...
            <div className="CONTENIDO">
                {oferta ? (
                    <div className="DEMANDANTE">
                        {loading && (
                            <div className="loading">Cargando oferta...</div>
                        )}
                        ...
                        <div className="det-ofer-container">
                            ...
                            <div className="right-oferta">
                                ...
                                <div className="right-section-ofer">
                                    <h3>Vacantes</h3>
                                    <p>
                                        {oferta.num_puesto} puestos disponibles
                                    </p>
                                </div>
                                <div className="right-section-ofer">
                                    ...
                                    <p>
                                        {oferta.titulos?.join(", ") ||
                                            "No se requieren títulos específicos"}
                                    </p>
                                </div>
                            </div>
                        </div>
