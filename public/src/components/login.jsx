                ...
                switch (data.rol) {
                    ...
                    case "empresa":
                        ...
                        switch (data.validado) {
                            case -1:
                                setErrorMessage(
                                    "Tu cuenta ha sido rechazada. Por favor contacta al administrador.",
                                );
                                break;
                            case 0:
                                setErrorMessage(
                                    "Tu cuenta está pendiente de validación. Por favor espera la confirmación.",
                                );
                                break;
                            case 1:
                            ...
                            default:
                                setErrorMessage(
                                    "Estado de validación desconocido",
                                );
                        }
                        break;
                    case "centro":
                ...
                <div className="right-section">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="input-group">
                            <label htmlFor="email" className="login-lab-email">
                                Email
                            </label>
                            <input
                                type="email"
