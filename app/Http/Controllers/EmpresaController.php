...
class EmpresaController extends Controller
{
    ...
    public function getPerfil($id)
    {
        try {
            ...
            Log::error("Error al obtener perfil empresa: " . $e->getMessage());
    ...
    public function actualizarPerfil(Request $request, $id)
    {
        try {
            ...
            $usuario = Usuario::where('email', $empresa->email)
                            ->where('rol', 'empresa')
                            ->firstOrFail();
            ...
            $validated = $request->validate([
                ...
                'localidad.max' => 'La localidad es demasiado larga',
                'telefono.digits' => 'El número de teléfono debe comenzar con 6 o 7 y tener un total de 9 dígitos.',
